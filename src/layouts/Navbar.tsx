...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div className="use-container flex h-24 items-center justify-between dark:bg-black lg:bg-transparent dark:lg:bg-transparent">
      ...
      {showMenu && (
        <nav className="top-30 fixed left-0 z-50 w-full space-y-1 rounded-b-lg bg-white py-3 px-2 drop-shadow-lg dark:bg-[#212425] lg:hidden">
          {navLinks.map((item) => (
