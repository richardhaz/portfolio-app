...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <div className="use-container sticky top-0 z-50 flex h-20 items-center justify-between bg-[#F2F5F6] dark:bg-black md:h-24 lg:bg-transparent dark:lg:bg-transparent">
